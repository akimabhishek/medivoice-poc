...
# 2. Add a tripwire to print to the Hugging Face logs!
if not api_key:
    print("🚨 FATAL ERROR: The Hugging Face environment is NOT providing the GEMINI_API_KEY!")
else:
    print(f"✅ API Key successfully loaded! (Starts with: {api_key[:5]}...)")
